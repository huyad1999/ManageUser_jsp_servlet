 ...
 * TblDetailUserJapan.java May 3, 2022 nguyenbahuy
 */
...
public class TblDetailUserJapan {
	...
	private String detailUserJapanId;
	private int userId;
	 ...
	 */
	public String getDetailUserJapanId() {
		return detailUserJapanId;
	}
	/**
	 * @param detailUserJapanId the detailUserJapanId to set
	 */
	public void setDetailUserJapanId(String detailUserJapanId) {
